...
var Habit = function Habit(props) {
    return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        ...
        props.remove && __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
            'button',
            { onClick: function onClick() {
                    return props.dispatch(Object(__WEBPACK_IMPORTED_MODULE_2__actions_habitA__["c" /* resetHabit */])(props.title));
                }, __source: {
                    fileName: _jsxFileName,
                    lineNumber: 11
                }
        ...
        value: function componentDidMount() {
            ...
            __WEBPACK_IMPORTED_MODULE_1__axios_axios__["a" /* default */].get('/habits.json').then(function (_ref) {
                ...
                for (var habit in data) {
                    _this2.props.dispatch(Object(__WEBPACK_IMPORTED_MODULE_2__actions_habitA__["a" /* createHabit */])(data[habit]));
                }
            });
        }
    }, {
...
//# sourceMappingURL=3.e0a6ece379d4c8b35485.hot-update.js.map